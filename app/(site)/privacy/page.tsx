...
export default function PrivacyPage() {
  ...
  return (
    <div className="py-12 bg-gradient-to-br from-background via-amber-50/20 to-orange-50/30">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <Card className="border-amber-200 shadow-lg mb-6">
          ...
          <CardContent className="space-y-4 text-muted-foreground">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>
                {lang === "es" ? "Realizar pedidos" : "Placing orders"}
              </li>
              <li>
                {lang === "es" ? "Contactarnos" : "Contacting us"}
              </li>
              <li>
                {lang === "es"
        ...
        {/* فقط lang از context میاد و با Layout هماهنگه */}
      </div>
    </div>
  );
}
